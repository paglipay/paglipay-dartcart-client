...
// import authHeader from "../product-reviews/../product-reviews/authentication/AuthHeader";

import MiscTableOne from '../product-reviews/misc/MiscTableOne';
import MiscTableTwo from '../product-reviews/misc/MiscTableOne';
import ReactIcon from '../product-reviews/misc/ReactIcon';
import ProductPurchaseCard from '../product-reviews/product-purchase-card/ProductPurchaseCard';
import ProductReviewCard from "../product-reviews/product-review-card/ProductReviewCard"
import ProductImages from '../product-reviews/ProductImages';
import ProductReviewDetail from '../product-reviews/ProductReviewDetail';
import ReviewCrousel from '../product-reviews/misc/ReviewCrousel';
import ProductCrousel from '../product-reviews/misc/ProductCrousel';
...
function LayoutOne() {
    ...
    //     const dataDb = require('../product-reviews/misc/data.json')
    //     // console.log(dataDb)
    //     dataDb.map(e => {
    //         console.log(e)
